  ...
  return (
    <div className='bg-blue-950 min-h-screen text-white'>
      ...
      <div className="main flex flex-col m-auto w-full  gap-7 text-center items-center border-b-2 border-gray-600 py-3">
        ...
        <img className='w-40 h-40 rounded-full' src="john 1.jfif" alt="" />
      </div>
    ...
    <div className='bg-blue-950 px-15 text-white min-h-screen w-screen space-y-5'>
      ...
      <div className="boxes flex gap-5 w-full h-120 justify-center border-b-2 border-gray-500 px-20 py-3">
        <div className="box w-[45%] h-full">
          <img className='w-full h-full bg-cover' src="john 2.jfif" alt="" />
        </div>
        <div className="box w-[45%] h-full">
          <img className='w-full h-full bg-cover' src="john 3.jfif" alt="" />
        </div>
      </div>
      <div className="boxes flex gap-5 w-full h-120 justify-center border-b-2 border-gray-500 px-20 py-3">
        <div className="box w-[45%] h-full">
          <img className='w-full h-full bg-cover' src="john 4.jfif" alt="" />
        </div>
        <div className="box w-[45%] h-full">
          <img className='w-full h-full bg-cover' src="john 5.jfif" alt="" />
        </div>
      </div>
      <div className="boxes flex gap-5 w-full h-120 justify-center border-b-2 border-gray-500 px-20 py-3">
        <div className="box w-[45%] h-full">
          <img className='w-full h-full bg-cover' src="john 6.jfif" alt="" />
        </div>
        <div className="box w-[45%] h-full">
          <img className='w-full h-full bg-cover' src="john 7.jfif" alt="" />
        </div>
      </div>
    </div>
  )
